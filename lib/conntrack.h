...
enum pat_action {
    PAT_ACTION_SRC_VALUE       = 0x4,
    PAT_ACTION_DST_VALUE       = 0x8,
    PAT_ACTION_TRANSLATE       = 0x0,
    PAT_ACTION_UNTRANSLATE     = 0x1,
    PAT_ACTION_REVERSE         = 0x2,

    PAT_ACTION_SRC_TRANSLATE   = PAT_ACTION_SRC_VALUE | PAT_ACTION_TRANSLATE,
    PAT_ACTION_DST_TRANSLATE   = PAT_ACTION_DST_VALUE | PAT_ACTION_TRANSLATE,
    PAT_ACTION_SRC_UNTRANSLATE = PAT_ACTION_SRC_VALUE | PAT_ACTION_UNTRANSLATE,
    PAT_ACTION_DST_UNTRANSLATE = PAT_ACTION_DST_VALUE | PAT_ACTION_UNTRANSLATE,
    PAT_ACTION_SRC_REVERSE     = PAT_ACTION_SRC_VALUE | PAT_ACTION_REVERSE,
    PAT_ACTION_DST_REVERSE     = PAT_ACTION_DST_VALUE | PAT_ACTION_REVERSE,
};
